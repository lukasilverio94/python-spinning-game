...
# The count of each symbol in the slot machine
symbol_count = {"A": 2, "B": 4, "C": 6, "D": 8}

# The value of each symbol in the slot machine
symbol_value = {"A": 5, "B": 4, "C": 3, "D": 2}


# Function to check the winnings after a spin
...
# Function to print the slot machine spin result
...
# Run the game if the script is run directly
